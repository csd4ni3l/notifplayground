...
window = arcade.Window(width=resolution[0], height=resolution[1], title='NotifPlayground', samples=antialiasing, antialiasing=antialiasing > 0, fullscreen=fullscreen, vsync=vsync, resizable=False, style=style)
